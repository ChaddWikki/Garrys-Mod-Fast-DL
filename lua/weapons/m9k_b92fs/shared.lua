...
SWEP.Gun = ("m9k_b92fs") -- must be the name of your swep but NO CAPITALS!
...
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "Beretta 92FS"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_pist_b92f.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_pist_b92f.mdl"	-- Weapon world model
...
SWEP.Primary.Sound			= Sound("b92fs_shot")		-- Script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-3.34125, 0, 1.535)	--Iron Sight positions and angles. Use the Iron sights utility in 
SWEP.IronSightsAng = Vector(0, 0.025, 0)	--Clavus's Swep Construction Kit to get these vectors
SWEP.SightsPos = Vector (-3.34125, 0, 1.535)
SWEP.SightsAng = Vector (0, 0.025, 0)
SWEP.RunSightsPos = Vector(0.825, -11.575, -3.675)	--These are for the angles your viewmodel will be when running
