...
SWEP.Gun = ("m9k_akm") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/v_rif_ak47m.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_rif_ak47m.mdl"	-- Weapon world model
...
SWEP.Primary.Sound			= Sound("akm.shot")		-- Script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.40405, 0, 0.3)
SWEP.IronSightsAng = Vector(0.065, 0.042, 0)
SWEP.SightsPos = Vector (-2.40405, 0, 0.3)
SWEP.SightsAng = Vector (0.065, 0.042, 0)
SWEP.RunSightsPos = Vector(2.68, -2.825, -0.405)
SWEP.RunSightsAng = Vector(-13.605, 40.025, -2.815)
