...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create("m9k_ammo_box")
...
function ENT:OnTakeDamage(dmginfo)
	...
	local dice = math.random(1,23,42,123,463,32,45,41,312,888,752) //This is the rng (U can get lucky with the first shot or 14 shots to blow it up)
...
if not IsValid(self) then return end
	...
	effectdata:SetScale(6.5)			// Size of explosion
	effectdata:SetRadius(67)		// What texture it hits
	effectdata:SetMagnitude(21.5)			// Length of explosion trails
	util.Effect( "m9k_gdcw_cinematicboom", effectdata )
	--generic default, you are a god among men
	
	util.BlastDamage(self.Entity, (self:OwnerCheck(attacker)), self.Entity:GetPos(), 3500, 1500)
